...
<HTML lang = "en">
	...
	<BODY>
		<STYLE type = "text/css">
			#slide1 {
				background:url('../Images/slide5.png') 50% 0 no-repeat fixed;
				color: #fff;
				height: 700px;
				margin: 0;
		...
		<DIV id = "slide1">
			<DIV id = "text">
				<A href = "../index.php" style = "text-decoration: none;color: white">Developers</A>
			</DIV><BR /><BR /><BR /><BR />
			<DIV class = "container">
				<DIV class = "row">
					<?php
						get_developers($database_handler) ;
					?>
				</DIV>
			</DIV>
		</DIV>
